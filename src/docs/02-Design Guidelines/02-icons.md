These icons are the official icons we use on yousee.dk. The purpose for this list is to provide you an overview of all icons, but also to make sure you can download our SVG files in a convenient way.

These are the official icons we use for yousee.dk. The purpose for this list is to provide an overview of all icons, but also to make sure you can download the SVG files in a convenient way.
